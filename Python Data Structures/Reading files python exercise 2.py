...
# output as shown below. Do not use the sum() function or a variable named sum 
# in your solution.
...
for line in fh:
    ...
    count = count + 1
    line = line.rstrip()
    xvalue = float(line[18+2:])
    avalue = avalue + xvalue
print("Average spam confidence:", avalue/count)
